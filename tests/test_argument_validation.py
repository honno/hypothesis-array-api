...
@mark.parametrize(
    ...
    [
        ...
        e(xpst.indices, shape=0),
        e(xpst.indices, shape=("1", "2")),
        e(xpst.indices, shape=(0, -1)),
        e(xpst.indices, shape=(0, 0), allow_none=None),
        e(xpst.indices, shape=(0, 0), allow_ellipsis=None),
        e(xpst.indices, shape=(0, 0), min_dims=-1),
        e(xpst.indices, shape=(0, 0), min_dims=1.0),
        e(xpst.indices, shape=(0, 0), max_dims=-1),
        e(xpst.indices, shape=(0, 0), max_dims=1.0),
        e(xpst.indices, shape=(0, 0), min_dims=2, max_dims=1),
    ],
)
